...
export default function ChatPanel({ onNavigate }) {
  ...
  const { user, isLocked, loginWithGoogle, logout } = useAuth();
      ...
      <div className="chat-header">
        ...
        <div className="chat-header-actions">
          {user ? (
            ...
            <button className="icon-btn login-btn" onClick={loginWithGoogle} title="Sign In with Google">🔑</button>
          )}
      ...
      {isLocked ? (
        <div className="chat-lock-overlay">
          <div className="chat-lock-content">
            ...
            <button className="btn-gold google-auth-btn" onClick={loginWithGoogle}>
